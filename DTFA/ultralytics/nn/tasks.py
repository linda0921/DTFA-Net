...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg="yolov8n.yaml", ch=3, nc=None, verbose=True):  # model, input channels, number of classes
        ...
        # Build strides
        m = self.model[-1]  # Detect()
        if isinstance(m, (Detect, ASFFv10Detect, Detect_dyhead)):  # includes all Detect subclasses like Segment, Pose, OBB, WorldDetect
            s = 640  # 640 2x min stride
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            C1, C2, C2f, RepNCSPELAN4, ELAN1, ADown, AConv, SPPELAN,ASPP,BasicRFB,SPPCSPC,SPPCSPC_group,SPPFCSPC,
            ...
            DWConvTranspose2d, C3x, RepC3, C2f_ACmix, C2f_AKConv, AKConv, C2f_Context,
                 ...
                 C2f_iRMB, LCCS, C2f_ODConv, ODConv2d, RCSOSA, CSPStage, RepConv, RFAConv, C2f_RFAConv,
                 SAConv2d, C2f_SAConv, C2f_SCConv, C2f_SENetV1, C2f_SENetV2, VoVGSCSP, SPDConv, TACS, GSConv,
                 C2f_iRMB_EMA, C2f_CGA, SimConv, nn.Conv2d, C2f_MSBlock, C2f_OREPA, C2f_DCNv4, CSPPC, CSPHet, C2f_Dual,
                 C2f_DCNv3, Blocks, ConvNormLayer, C2f_FasterBlock, RepNCSPELAN4_high,  C2f_DCNv3_DLKA,
                 RepNCSPELAN4_low, C2f_DynamicConv, DynamicConv, Down_wt, C2f_GhostModule_DynamicConv, C2f_UIB, C2fCIB,
                 PSA, SCDown, C2fMLLABlock, PSABiformer, PFE, PSAMSDA, PSAEMA, PSASEAM, PSAMultiSEAM, PSAAcmix, PSASENetV2,
                 PSALSKA, PSAMLCA, PSAMLLA, C2fCIB_iAFF, C2f_iAFF,C2f_Faster,C3_Faster,FEM,SimSPPF
        }:
            c1, c2 = ch[f], args[0]
            ...
            if m in {BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2f_ACmix, C2f_AKConv,
                     ...
                     LCCS, C2f_ODConv, RCSOSA, CSPStage, C2f_RFAConv, C2f_SAConv, C2f_SCConv, C2f_SENetV1,
                     C2f_SENetV2, VoVGSCSP, TACS, C2f_iRMB_EMA, C2f_CGA, C2f_MSBlock, C2f_OREPA, C2f_DCNv4,
        ...
        #---------------------------------------注意力机制------------------------
                   ...
                   SPDEMA, AirNet, ADNet, RIDNET, MLLAttention,LAE}:
            c2 = ch[f]
            args = [c2, *args]
        # ---------------------------------------注意力机制-----------------------
        # ---------------------------------------主干----------------------------
        ...
        # ------------------------------ASF-YOLO--------------------------------
            ...
            c2 = sum(ch[x] for x in f)
        elif m in {Detect, WorldDetect, Segment, Pose, OBB, ImagePoolingAttn, v10Detect, ASFFv10Detect, DBBv10Detect,Detect_dyhead}:
    ...
    if isinstance(model, nn.Module):  # PyTorch model
        ...
        for m in model.modules():
            if isinstance(m, Segment):
                ...
                return "obb"
            elif isinstance(m, (Detect, WorldDetect, v10Detect, ASFFv10Detect, DBBv10Detect,Detect_dyhead)):
                return "detect"
