...
import numpy as np
from ultralytics.nn.Addmodules.OREPA import OREPA
__all__ = ['DBBv10Detect']
...
class DBBv10Detect(Detect):
    ...
    def __init__(self, nc=80, ch=()):
        ...
        self.cv3 = nn.ModuleList(
            nn.Sequential(
                nn.Sequential(DiverseBranchBlock(x, x, 3, groups=x), Conv(x, c3, 1)),
                nn.Sequential(DiverseBranchBlock(c3, c3, 3, groups=c3), Conv(c3, c3, 1)),
...
if __name__ == "__main__":
    ...
    channel = (64, 128, 256)
    # Model
    mobilenet_v1 = DBBv10Detect(nc=80, ch=channel)
    out2 = mobilenet_v1(image)
    print(out2)